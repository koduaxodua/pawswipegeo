...
const TRANSLATIONS = {
  ...
  'addDog.toast.requiredFields': { ka: 'გთხოვთ შეავსოთ სავალდებულო ველები და აირჩიე ლოკაცია რუკაზე', en: 'Please fill required fields and pick a location on the map' },
  ...
  'tutorial.s4.desc':       { ka: 'ქვედა მენიუში "+" ღილაკი — თუ შენ იცი მიუსაფარი ცხოველი, აიტვირთე მისი ფოტო და მონაცემები. ყველა მომხმარებელი ნახავს.', en: 'Tap "+" in the bottom menu — if you know a homeless pet, upload its photo and details. Everyone will see it.' },
